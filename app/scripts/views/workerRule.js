          ...
          dataSrc: function(data) {
            var modData = _.map(data, function(row) {
              return {
                ...
                modifiedOn: (row.ModifiedOn) ? moment(row.ModifiedOn, 'DD/MM/YYYY').format('DD MMM YYYY') : '',
                modifiedBy: row.ModifiedBy,
                summary: row.Summary,
                score: row.Score,
                startDate: (row.StartDate) ? moment(row.StartDate, 'DD/MM/YYYY').format('DD MMM YYYY') : '',
                endDate: (row.EndDate) ? moment(row.EndDate, 'DD/MM/YYYY').format('DD MMM YYYY') : ''
              };
            });
            return modData;
